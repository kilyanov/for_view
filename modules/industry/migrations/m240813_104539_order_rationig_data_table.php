...
/**
 * Class m240813_104539_order_rationig_data_table
 */
class m240813_104539_order_rationig_data_table extends Migration
{
    public const TABLE_NAME = 'order_rationing_data';

    private string $table = '{{%' . self::TABLE_NAME . '}}';
    private string $unit = '{{%unit}}';
    private string $rationing = '{{%order_rationing}}';
    ...
    public function safeUp()
    {
        $this->createTable($this->table, [
            ...
            'normaAll' => $this->decimal(10, 2)->null()->comment('Н/Ч'),
