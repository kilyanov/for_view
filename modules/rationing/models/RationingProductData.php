...
use app\modules\industry\behaviors\RationingDataBehavior;
...
use app\modules\rationing\behaviors\RationingProductDataBehavior;
...
/**
 * This is the model class for table "{{%rationing_product_data}}".
 *
 ...
 * @property float|null $normaAll Н/Ч общ.
 ...
 * @property RationingProduct $rationingRelation
 * @property PersonalSpecial $specialRelation
 * @property Unit $unitRelation
 *
 * @property-read string $fullName
 */
class RationingProductData extends ActiveRecord implements HiddenAttributeInterface
{
    ...
    public function behaviors(): array
    {
        ...
        return ArrayHelper::merge($behaviors, [
            'RationingProductDataBehavior' => [
                'class' => RationingProductDataBehavior::class,
            ],
            'RationingDataBehavior' => [
                'class' => RationingDataBehavior::class,
            ],
        ]);
    }
     ...
     *
     * @return ActiveQuery|RationingProductQuery
     */
    public function getRationingRelation(): ActiveQuery|RationingProductQuery
    {
        return $this->hasOne(RationingProduct::class, ['id' => 'rationingId']);
    }
    ...
    /**
     * {@inheritdoc}
     * @return RationingProductDataQuery the active query used by this AR class.
     */
    public static function find(): RationingProductDataQuery
    {
        return new RationingProductDataQuery(get_called_class());
    }
